                ...
                foreach (var row in lines) 
                {
                    ...
                    if (!UseDescription) 
                    {
                        ...
                        for (int i = 1; i <= numInputs.Value; i++) 
                        {
                            ...
                            {
                                ExceptionHandler.LogException(new Exception("Number of inputs likely no matchy. Fix plz. Record to check: " + row["description"], e)
                                );
                            }
                        }
                    ...
                    if (loweredDescription.Contains("corrupt item") ||
                        ...
                        loweredDescription.Contains("transfer out gems") ||
